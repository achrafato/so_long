...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/05 11:44:40 by aibn-che          #+#    #+#             */
/*   Updated: 2024/02/19 16:21:39 by aibn-che         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	render_pixels(char **arr)
{
	...
	mlx_loop_hook(data.mlx_ptr, &enemy_loop, (void *)&data);
